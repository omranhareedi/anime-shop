...
def seed_database():
    ...
    products = [
        Product(name='Naruto Shippuden - Sage Mode Figure',
                ...
                category_id=categories[0].id, is_featured=True,
        ...
        Product(name='Demon Slayer - Tanjiro Hoodie',
                ...
                category_id=categories[1].id, is_featured=True,
        ...
        Product(name='Spy x Family - Anya Poster',
                ...
                category_id=categories[2].id, is_featured=True,
        ...
        Product(name='Chainsaw Man - Pochita Keychain',
                ...
                category_id=categories[3].id, is_featured=False,
        ...
        Product(name='Demon Slayer Vol.1 - Manga',
                ...
                category_id=categories[4].id, is_featured=False,
        ...
        Product(name='Attack on Titan Vol.1 - Manga',
                ...
                category_id=categories[4].id, is_featured=True,
        ...
        Product(name='Fullmetal Alchemist - Ed & Al Figure',
                ...
                category_id=categories[0].id, is_featured=False,
        ...
        Product(name='Cowboy Bebop - Spike Spiegel Poster',
                ...
                category_id=categories[2].id, is_featured=False,
